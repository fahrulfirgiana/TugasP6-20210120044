...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future userLogin() async {
    String url = "http://192.168.7.73/tugasp6/restapi/user_login.php";
    setState(() {
      _visible = true;
    });
    ...
    try {
      ...
      // ignore: avoid_print
      print(response.body); // Print the response for debugging
      ...
      if (response.statusCode == 200) {
        ...
        if (msg['loginStatus'] == true) {
          ...
          if (userInfo != null) {
            var userName =
                userInfo['uname']; // Assuming the column name is 'uname'
            if (userName != null) {
              ...
              showMessage("Invalid username in user information");
            }
          } else {
